...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2021 at 08:33 AM
...
(29, '2021010105', 'D006', '02010', '0701', '001', 5, 10),
...
(41, '2021020105', 'D053', '02010', '0505', '004', 4, 6),
...
(104, '2021010103', 'D024', '02010', '0615', '001', 5, 10),
(105, '2021010103', 'D024', '02010', '0619', '001', 5, 10),
...
(113, '2021020103', 'D027', '02010', '0501', '001', 5, 10),
(114, '2021020104', 'D027', '02010', '0501', '001', 5, 10),
(115, '2021010106', 'D027', '02035', '0707', '003', 1, 4),
(116, '2021020103', 'D027', '02010', '0615', '001', 5, 10),
(117, '2021020104', 'D027', '02010', '0617', '001', 5, 10),
...
(129, '2021020109', 'D030', '02010', '0716', '001', 5, 10),
(130, '2021020108', 'D030', '02010', '0715', '001', 5, 10),
...
(144, '2021020105', 'D053', '02010', '0717', '004', 8, 10),
...
(215, '2021010106', 'D049', '02010', '0716', '001', 5, 10),
...
(221, '2021020105', 'D053', '02010', '0504', '001', 10, 12),
...
(231, '2021010104', 'D052', '02010', '0701', '001', 5, 10),
(232, '2021020201', 'D052', '02005', '0708', '002', 7, 12),
(233, '2021020202', 'D052', '02005', '0720', '003', 7, 12),
(234, '2021010104', 'D052', '02030', '0618', '005', 1, 6),
(235, '2021020105', 'D053', '02010', '0708', '001', 5, 10),
(236, '2021020105', 'D053', '02010', '0704', '005', 7, 12),
...
(267, '2021020105', 'D053', '02010', '0805', '003', 7, 10),
...
(285, '2021020102', 'D065', '02010', '0708', '001', 5, 10),
(286, '2021020102', 'D065', '02030', '0615', '004', 1, 6),
(287, '2021010206', 'D066', '02013', '0503', '001', 4, 6),
(288, '2021020104', 'D067', '02003', '0805', '001', 4, 6),
(289, '2021020105', 'D053', '02010', '0805', '001', 4, 6),
(290, '2021020105', 'D053', '02010', '0705', '003', 1, 6),
...
(338, '2021020105', 'D053', '02010', '0506', '005', 2, 5),
...
(352, '2021010101', 'D082', '02010', '0707', '001', 5, 10),
(353, '2021010102', 'D082', '02010', '0707', '001', 5, 10),
(354, '2021010101', 'D082', '02030', '0720', '002', 7, 12),
(355, '2021010102', 'D082', '02030', '0508', '005', 1, 6),
(356, '2021020106', 'D083', '02010', '0617', '001', 5, 10),
...
('2041720030', 'Nazela Hanum Mukhidah', '2021020105'),
('2041720061', 'Siti Aisyah', '2021020105'),
('2041720088', 'Shintya Rahmawati', '2021020105'),
('2041720127', 'Afvanie Rama Ardyansyah', '2021020105'),
('2041720138', 'Salwa Zhafira Pratiwi Wahyudi', '2021020105'),
('2041720164', 'Achmad Ainun Naim', '2021020105'),
('2041720170', 'Ridho Triadhilaksono', '2021020105'),
('2041720173', 'Novianawati', '2021020105'),
('2041720195', 'Novitasari', '2021020105'),
('2041720219', 'Rossa Akmalia', '2021020105');
...
--
-- Table structure for table `mk_backup`
--

CREATE TABLE `mk_backup` (
  `kode_mk_backup` varchar(5) NOT NULL,
  `nama_mk_backup` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `mk_backup`
--

INSERT INTO `mk_backup` (`kode_mk_backup`, `nama_mk_backup`) VALUES
('02001', 'Agama'),
('02002', 'Alajabar Linier'),
('02003', 'Algoritma dan Struktur Data'),
('02004', 'Aljabar Linier'),
...
--
-- Indexes for table `mk_backup`
--
ALTER TABLE `mk_backup`
  ADD PRIMARY KEY (`kode_mk_backup`);
...
--
ALTER TABLE `mahasiswa`
  ADD CONSTRAINT `mahasiswa_ibfk_1` FOREIGN KEY (`kode_kelas`) REFERENCES `kelas` (`kode_kelas`);
COMMIT;
